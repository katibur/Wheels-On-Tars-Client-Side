  ...
  return (
    <div>
      <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        <div className="mb-5">
          <h2 className="text-xl text-center font-bold">As buyer</h2>
          <h2 className="text-lg text-center">
            Email:{" "}
            <span className="font-bold text-red-400">buyer1@gmail.com</span>
          </h2>
          <h2 className="text-lg text-center">
            password: <span className="font-bold text-red-400">7887sS$.</span>
          </h2>
        </div>

        <div>
          <h2 className="text-xl text-center font-bold">As seller</h2>
          <h2 className="text-lg text-center">
            Email:{" "}
            <span className="font-bold text-red-400">seller1@gmail.com</span>
          </h2>
          <h2 className="text-lg text-center">
            password: <span className="font-bold text-red-400">7887sS$.</span>
          </h2>
